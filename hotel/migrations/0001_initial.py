    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Apartment', max_length=30)),
                ('owner', models.CharField(default='Abc', max_length=20)),
                ('location', models.CharField(default='Udupi', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.location')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
